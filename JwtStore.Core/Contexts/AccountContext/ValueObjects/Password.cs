...
{
    private const string Valid = "abcdefdhijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
    private const string Special = "!@#$%^&*()[]Ç";
        ...
        char splitChar = '.')
    {
        if (string.IsNullOrEmpty(password))
            throw new Exception("Password não pode ser nulo ou vazio!");
